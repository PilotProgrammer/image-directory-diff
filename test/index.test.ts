...
describe("Test file comparison", function () {
  ...
  it("Test image comparison", async () => {
    ...
    const image1 = await factory.createMediaFile(imageFileName1)
    const image2 = await factory.createMediaFile(imageFileName2)
    const image3 = await factory.createMediaFile(imageFileName3)
